...
export interface PipelineTrace {
  ...
  product_locked_composite: {
    ...
    product_has_alpha: boolean;
    product_alpha_bbox?: [number, number, number, number] | null;
    product_fallback_used: boolean;
    anchor_id: string;
    default_anchor_used: boolean;
    anchor_override_used: boolean;
