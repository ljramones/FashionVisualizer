...
def _render_hero_still(recipe: SceneRecipe, hero_path: Path) -> tuple[Path, dict[str, object], str]:
    ...
    metadata: dict[str, object] = {
        ...
        "device": device,
        "profile_id": settings.image_profile_id or None,
        "positive_prompt_preview": None,
    ...
    metadata.update(
        {
            ...
            "positive_prompt_preview": getattr(result, "positive_prompt_preview", None),
            ...
            "guidance_scale": getattr(result, "guidance_scale", None),
            "supports_negative_prompt": getattr(result, "supports_negative_prompt", None),
            "prompt_profile_used": getattr(result, "prompt_profile_used", None),
            "prompt_strategy": getattr(
                result,
                "prompt_strategy",
                "product_empty_scene_for_later_composite",
            ),
            "aspect_ratio_requested": getattr(
                result,
                "aspect_ratio_requested",
                recipe.aspect_ratio,
            ),
            "aspect_ratio_resolved": getattr(result, "aspect_ratio_resolved", None),
