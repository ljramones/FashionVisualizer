...
Placement is data-driven through each action's `composite_anchor` metadata. V1 is intentionally simple: no shadows, no edge blending, no pose estimation, and no background removal. Visual quality may require manual anchor adjustment.
